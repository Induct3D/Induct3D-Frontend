...
import { mockTemplates } from "../../../infrastructure/constants/templates"; // ajusta esta ruta según tu estructura
...
export default function SelectTemplateModal({ isOpen, onClose, onConfirm }: SelectTemplateModalProps) {
