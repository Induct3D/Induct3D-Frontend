...
const navItems = [
    { path: "/admin", label: "Inicio", icon: <FiHome /> },
    { path: "/admin/recorridos", label: "Gestionar recorridos", icon: <FiList /> },
];
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center gap-3 px-3 py-2 rounded-lg font-medium transition ${
                                    isActive ? "bg-[#A71C20] text-white" : "text-gray-700 hover:bg-gray-100"
                                }`}
                            >
